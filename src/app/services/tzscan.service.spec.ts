...
describe('[ TzscanService ]', () => {
	...
	//testing data
	let apiUrl: string;
	const pkh = 'tz3RDC3Jdn4j15J7bBHZd29EUee9gVB1CxD9';
	...
	describe('> Return One-to-Many Operations', () => {
		const transaction = [{'hash': 'opVQfAyyKDb827m9CDanAtCNBS6FUEAJvqWNDbPa9WoqGLLrmsn',
			...
			'amount': 10000, 'destination': {'tz': 'tz3RDC3Jdn4j15J7bBHZd29EUee9gVB1CxD9', 'alias': 'Foundation Baker 1'},
			'failed': false, 'internal': false, 'burn': 0, 'counter': 225736, 'fee': 1420, 'gas_limit': '10300',
			'storage_limit': '300', 'op_level': 244814, 'timestamp': '2018-12-27T10:15:03Z'}]}}];
		const delegation = [{'hash': 'ontXQ6GhatPzPTXCFXmR7dAsaocPeZDzg5BsSVX8SMuYvfyPd6b',
			'block_hash': 'BLGxAwqttAHMe3dtL5G94AXAXCmLHyjLbMT32D2Aim2z1EsFsoH', 'network_hash': 'NetXdQprcVkpaWU',
			'type': {'kind': 'manager', 'source': {'tz': 'KT1DgtZe1cEitiTPv5HSbYCd33E7n8GUq3kM'},
			'operations': [{'kind': 'delegation', 'src': {'tz': 'KT1DgtZe1cEitiTPv5HSbYCd33E7n8GUq3kM'},
			'delegate': {'tz': 'tz3RDC3Jdn4j15J7bBHZd29EUee9gVB1CxD9', 'alias': 'Foundation Baker 1'},
			'counter': 2, 'fee': 0, 'gas_limit': '0', 'storage_limit': '0', 'failed': false, 'internal': false,
			'op_level': 7055, 'timestamp': '2018-07-05T15:38:57Z'}]}}];
		...
		*/
		...
		it('should return one operation, type origination', () => {
			...
			// subscribe to observable
			const x = service.operationsOrigination(pkh, n)
				.subscribe((res: any) => {
